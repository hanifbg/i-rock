...
RSpec.describe Achievement, type: :model do
  describe 'validations' do
    ...
    # it 'require title to be unique for one use' do
  ...
  it 'only fetch achievements witch title starts from provided letter' do
    user = FactoryGirl.create(:user)
    ...
    expect(Achievement.by_letter("R")).to match_array(achievement1)
  end
